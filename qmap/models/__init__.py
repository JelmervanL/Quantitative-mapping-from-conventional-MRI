import importlib
from qmap.models.base_model import BaseModel
...
def find_model_using_name(model_name):
    ...
    model_filename = "qmap.models." + model_name + "_model"
    modellib = importlib.import_module(model_filename)

    # In the file, the class called ModelNameModel() will be instantiated.
